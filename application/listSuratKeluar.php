              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <div class="btn-group  btn-group">
                        <a href="<?=site_url($prev.'/addSurat');?>"><button class="btn btn-default" type="button">Tambah Surat</button></a>
                  </div>
                  <div class="x_content">					
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					  ...
					  <tbody>
						<?php foreach ($q as $row){
							...
							echo '<td>'.$row->kotak_surat.'</td>';
							echo '<td><a href ="'.base_url().'uploads/surat/'.$row->attachment.'">Download</a></td>';
							echo '<td><a href ="'.site_url($prev.'/edtSurat/?id='.$row->id).'">Edit</a> |';
						?>
							<a href ="<?php echo site_url($prev.'/deleteSurat/?id='.$row->id)?>"onclick="return confirm('Are you sure?');">Delete</a></td>
						<?php
							echo '</tr>';
							}
						?>
