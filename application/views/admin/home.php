		...
		<!-- top tiles -->
          <div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-th"></i> Total Pekerjaan</span>
              <div class="count"><?php echo $q[0]->pekerjaan ?></div>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-th-list"></i> Total Barang</span>
          ...
          <div class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-th"></i> Total Pekerjaan</span>
              <div class="count"><?php echo $r[0]->pekerjaan ?></div>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-th-list"></i> Total Barang</span>
              <div class="count"><?php echo $r[0]->barang ?></div>
            </div>	
          </div>
		 </div>
		</div>
